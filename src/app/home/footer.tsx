...
export function Footer() {
    return (
        <footer className="border-t-2 border-white bg-gradient-to-r from-pink-100 via-purple-100 to-cyan-100 rounded-2xl">
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    {/* Company Info */}
                    <div className="space-y-3">
                        <h3 className="text-lg font-semibold">Loomibg</h3>
                        <p className="text-sm text-muted-foreground">Criando projetos do zero e experiências incríveis para a web.</p>
                    </div>
