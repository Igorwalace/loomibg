                    ...
                    <TabsList className="grid grid-cols-2 border-white md:grid-cols-4 w-full mb-12 h-auto gap-2 bg-transparent">
                        {demos.map((demo) => (
                            <TabsTrigger
                                key={demo.id}
                                value={demo.id}
                                className="flex flex-col items-center gap-2 py-4 data-[state=active]:bg-[#006666] data-[state=active]:text-primary-foreground rounded-lg border-2 data-[state=active]:border-white transition-all"
                            >
                                    ...
                                    <div className="space-y-4">
                                        <div className="text-center mb-2">
                                            <span className="text-sm font-semibold text-primary uppercase tracking-wider">
                                                {demo.before ? "Depois" : "Resultado"}
                                            </span>
                                        </div>
                                        <div className="relative bg-banner rounded-lg overflow-hidden border-2 border-primary/50 bg-muted/20 flex justify-center">
                                            <Image
